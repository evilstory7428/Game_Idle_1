...
const files=['assets.js','phase2-art.js','game.js','campaign.js','phase2-combat.js','phase2-ui.js','phase3-equipment-pre.js','phase3-reference.js','phase3-equipment.js','phase3-polish.js','phase3b-progression.js','boot.js','mobile-app.js','sw.js'];
const checked=[];
